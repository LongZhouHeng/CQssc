package com.jdruanjian.cqssc.ui.fragment;
...
import com.jdruanjian.cqssc.BaseFragment;
import com.jdruanjian.cqssc.Constants;
import com.jdruanjian.cqssc.R;
import com.jdruanjian.cqssc.adapter.Random1ResultAdapter;
import com.jdruanjian.cqssc.adapter.RandomResultAdapter;
import com.jdruanjian.cqssc.model.basicmodel.NewPeriodModel;
import com.jdruanjian.cqssc.model.basicmodel.QueryResultModel;
import com.jdruanjian.cqssc.model.entity.NewPeriodBean;
import com.jdruanjian.cqssc.model.entity.RegisterBean;
import com.jdruanjian.cqssc.model.entity.ResultListBean;
import com.jdruanjian.cqssc.model.net.BasicResponse;
import com.jdruanjian.cqssc.model.net.NewPeroidAPI;
...
public class Fragment2 extends BaseFragment {
    ...
    public void getNewPeriod() {
        ...
        NewPeroidAPI api = new NewPeroidAPI(getActivity(), "type_cqssc", new BasicResponse.RequestListener() {
            @Override
            public void onComplete(BasicResponse response) {
                if (response.error == BasicResponse.SUCCESS) {
                    ...
                    if (newPeriodModel.msgContext.equals("datasSuc")) {
                        ...
                        tvFive4.setText(NewNumber.substring(3, 4));
                        tvFive5.setText(NewNumber.substring(4));
    ...
    private void getDetail() {
        ...
        lv.loadUrl("http://www.bzjihua.com/app/index.html?planInfoId=" + planId + "&planNum=" + tvPlan.getText().toString() +
                "&phase=" + tvPeroid1.getText().toString() + "&uid=" + uid + "&appid=" + "2");
